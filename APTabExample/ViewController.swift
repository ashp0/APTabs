...
class ViewController: NSViewController, AXTabViewDelegate {
    ...
    private func setupUI() {
        // Configure AXTabView
        axTabView.styler = SafariTabStyle()  // or SafariTabStyle()
    ...
    func didAddNewTab() {
        ...
        contentTabView.addTabViewItem(newTab)
        contentTabView.selectTabViewItem(newTab)
        axTabView.reloadTabs()
    }
}
